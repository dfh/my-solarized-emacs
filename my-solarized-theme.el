...
(my-apply-faces
 '(
   ...
   (org-todo :weight bold :foreground bg-3 :background red)
   (org-done :weight bold :foreground green)
   (org-todo-kwd-face :weight bold :foreground bg-3 :background red)
   (org-done-kwd-face :weight bold :foreground green)
   ...
   (org-drawer :weight bold :foreground blue)
